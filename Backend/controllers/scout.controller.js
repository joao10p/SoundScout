...
exports.save = function(req, res) {
    ...
    var query = "";
        ...
        query = con.query('INSERT INTO scout SET id=?, edicao=?, revista=?, capa=?,banner=?,slider1 =?,slider2 =?, slider3 =?, titulo =?, texto=?, txtimagem=?,cargoS=?', post, function(err, rows, fields) {
...
exports.update = function(req, res) {
    ...
    var query = "";
        ...
        query = con.query('UPDATE scout SET edicao=?, revista=?, capa=?,banner=?,slider1 =?,slider2 =?, slider3 =?, titulo =?, texto=?, txtimagem=?,cargoS=? where id=?', update, function(err, rows,
            fields) {
            console.log(query.sql);
            if (!err) {
