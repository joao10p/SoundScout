...
exports.readMax = function (req, res) {
    ...
    con.query('SELECT MAX(id) as id  from revista_sound', [id], function (err, rows, fields) {
        if (!err) {
...
exports.read_id = function (req, res) {
    ...
    con.query('SELECT * from revista_sound WHERE id =?', [id], function (err, rows, fields) {
        if (!err) {
...
exports.read_edicao = function (req, res) {
    con.query('SELECT id FROM revista_sound WHERE edicao = ( SELECT max(edicao) FROM revista_sound)', function (err, rows, fields) {
        if (!err) {
